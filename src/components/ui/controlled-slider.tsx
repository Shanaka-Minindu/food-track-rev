          ...
          <div className="grid w-full gap-4 rounded-md border border-[#14424C]/20 p-4">
            ...
            >
              <SliderPrimitive.Track
                ...
                className={cn(
                  "bg-muted relative grow cursor-pointer overflow-hidden rounded-full data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:"
                )}
              >
            ...
            <div className="flex flex-wrap gap-2">
              <ol className="flex w-full items-center justify-between rounded-md border px-3">
