...
import { useDeleteMeal } from "../_services/use-meal-mutation";
...
const MealCards = () => {
  const { updateSelectedMealId, updateMealDialogOpen, mealFilter } =
    useMealsStore();
  ...
  const displayDate = mealFilter.dateTime
    ? format(new Date(mealFilter.dateTime), "EEEE, MMMM d, yyyy")
    : "Today";
